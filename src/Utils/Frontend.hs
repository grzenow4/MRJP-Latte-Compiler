...
takeAttr pos attr x = do
    ...
    case Map.lookup attr env of
        ...
        Nothing ->
            maybe
                (throwError $ newErr pos ("Class has no attribute " ++ attr))
                (takeAttr pos attr)
                ext
...
takeMethod pos method x = do
    ...
    case Map.lookup method fenv of
        ...
        Nothing ->
            maybe
                (throwError $ newErr pos ("Class has no method " ++ method))
                (takeMethod pos method)
                ext
